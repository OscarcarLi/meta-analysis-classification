...
output='metal_cifar-fs-base_r12_FOMAMLinnUpd5T20Vp0.01_n5s5q15tb4_Adam0.01det45'
...
--eps 0. \
--restart-iter 20 \
--checkpoint runs/metal_cifar-fs-base_r12_FOMAMLinnUpd5T20p0.01_n5s5q15tb4_Adam0.01det204050/chkpt_020.pt \

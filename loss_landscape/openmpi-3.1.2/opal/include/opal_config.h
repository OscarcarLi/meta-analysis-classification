...
#define MCA_io_romio314_COMPLETE_CONFIGURE_FLAGS " FROM_OMPI=yes CC='clang' CFLAGS='-O3 -DNDEBUG -fno-strict-aliasing -mcx16 -pthread -D__EXTENSIONS__' CPPFLAGS='-I/home/amrith/meta-analysis-classification/loss_landscape/openmpi-3.1.2/opal/mca/event/libevent2022/libevent -I/home/amrith/meta-analysis-classification/loss_landscape/openmpi-3.1.2/opal/mca/event/libevent2022/libevent/include -I/home/amrith/meta-analysis-classification/loss_landscape/openmpi-3.1.2/opal/mca/hwloc/hwloc1117/hwloc/include -I/usr/include ' FFLAGS='' LDFLAGS=' ' --enable-shared --disable-static  --prefix=/opt/openmpi --disable-aio --disable-weak-symbols --enable-strict --disable-f77 --disable-f90"
...
#define OPAL_PACKAGE_STRING "Open MPI amrith@meta-2-vm Distribution"
...
#define WRAPPER_EXTRA_LIBS "-lm -lnuma -ldl -lutil  -lrt -lz"

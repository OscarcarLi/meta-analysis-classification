...
class ClassBalancedSampler(Sampler):
    ...
    def __iter__(self):
        for i in range(self._num_total_batches * self._meta_batch_size):
            # sample the classes for this batch
            ...
            # sample the examples for every class in the batch
            batch_samples = []
    ...
    # def __len__(self):
    #     return self._num_total_batches * self._num_classes_per_batch * self._num_samples_per_class
